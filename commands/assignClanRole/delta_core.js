...
module.exports = {
  name: "del_add",
  aliases: ['adddel', 'givedel'],
  description: "adds del role to a member",
...
let done = new MessageEmbed().setColor('GREEN').setDescription(`🟢 **|** **${membr.user.username + '#' + membr.user.discriminator}** has added **${clanName}** Clan Role`).setFooter({ text: `role changed by ${message.author.username}`});
